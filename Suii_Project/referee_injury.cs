...
{
    public partial class referee_injury : Form
    {
        public referee_injury()
        {
            InitializeComponent();
        }

        private void referee_injury_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    string query = "Insert into injury values('" + iid + "','" + pid + "','" + des + "')";
